...
const Perks = ({selected, onChange}) => {
  const handleCheckBox = (ev)=>{
      ...
      return  onChange([...selected,name])
        ...
        return  onChange([...selected.filter(selectedNames => selectedNames !== name)])
      }
  }
  return (
    <>
            <label className="border p-4 rounded-2xl flex gap-2 items-center">
              ...
              <label className="border p-4 rounded-2xl flex gap-4 items-center">
                <input type="checkbox" name="Private Entrance" onChange={handleCheckBox}/>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
